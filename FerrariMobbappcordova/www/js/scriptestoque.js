...
function Salvar() {
    ...
    if ($('#nome').val().trim() == '') {
        Materialize.toast('Campo Nome Do Produto é obrigatório!',2000);
        return false;

    }
    if ($('#qp').val().trim() == '') {
        Materialize.toast('Campo Quantidade  é obrigatório!',2000);
        return false;

    }
    if ($('#preco').val().trim() == '') {
        Materialize.toast('Campo Valor é obrigatório!',2000);
        return false;
